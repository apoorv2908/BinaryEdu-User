    ...
    return (
        ...
        <div className= 'mx-5'>
            ...
            >
                    ...
                    <Navbar.Brand><Link to="/"><img className=' mx-3 mno' src={logo} alt="Logo" /></Link></Navbar.Brand>
                            ...
                            {user ? (
                                <>
                                    {user.role === 'teacher' ? (
                                     ...
                                     <NavDropdown  className=' comb btn btn-warning p-0  btn-sm dba' title="Login/Registration" id="login-dropdown">
                                    <NavDropdown.Item as={Link} className= 'comb' to="/login-teacher"><i class=" mx-1 bi bi-person-video3"></i> Login/Registration (Teacher)</NavDropdown.Item>
                                    <NavDropdown.Item as={Link}  className= 'comb' to="/login-student"><i class=" mx-1 bi bi-person-fill"></i>Login/Registration (Student)</NavDropdown.Item>
                                    <NavDropdown.Item as={Link}  className= 'comb' to="/login-school"><i class="mx-1 bi bi-book"></i>Login/Registration (School)</NavDropdown.Item>
                                </NavDropdown>
