...
{type === 'answerkeys' && (
              <div className="zampa" controls>
                <source
                  src={`${config.apiBaseUrl}/admin/fullmarks-server/uploads/answerkeys/${resource.answerkeys_file}`}
                />
              </div>
            )}
      ...
      <hr />
        ...
        {resources.length > 0 ? (
          <>
            ...
            {renderResources('answerkeys', 'Answer Keys')}
